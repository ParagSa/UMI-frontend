...
export class DoctorRegis extends Component {
            ...
            <Card className="shadow px-4">
              <Card.Body>
                <div className="mb-3 mt-md-4">
                  <h2 className="fw-bold mb-2 text-center text-uppercase ">Doctor Registration</h2>
                  <div className="mb-3">
                  ...
                  onChange={this.handleChange}/>
                       ...
                       <Form.Group className="mb-3" controlId="dob">
                        ...
                        <Form.Control type="text" placeholder="Enter Medical Licence no" name = "licence" value={this.state.formData.licence}
                  onChange={this.handleChange} />
                      </Form.Group>
                      ...
                      <Form.Group className="mb-3" controlId="qualification">
                        ...
                        <Form.Control  as="select" name ="qaulification" value={this.state.formData.qualification}
                  onChange={this.handleChange} >
                     ...
                     <option value="PhysioTherapy">PhysioTherapy</option>
                      ...
                      <div className="text-danger">{this.state.errors.specialization}</div>

                      <Form.Group className="mb-3" controlId="specialization">
                        <Form.Label className="text-center">
                        Specialization
                        </Form.Label>
                        <Form.Control  as="select" name ="specialization" value={this.state.formData.specialization}
                  onChange={this.handleChange} >
                      <option value="">--Select--</option>
                  ...
                  onChange={this.handleChange} >
                     ...
                     <option value="other">Other</option>
                      ...
                      <Form.Group className="mb-3" controlId="city">
                        ...
                        <Form.Control type="text" placeholder="Enter City of Practice" name ="city" value={this.state.formData.city}
                  onChange={this.handleChange} />
                      </Form.Group>
...
{/* 
                  ...
                  onChange={this.handleChange} />
                      ...
                      <Form.Group className="mb-3" controlId="degreeCertificate">
                        <Form.Label className="text-center">
                          Degree Certificate Picture 
                        </Form.Label>
                        <Form.Control type="file" placeholder="Select Degree Picture" name="degreeCertificate" value={this.state.formData.degreeCertificate}
                  onChange={this.handleChange} />
                      </Form.Group>
                      <div className="text-danger">{this.state.errors.degreeCertificate}</div>
